...
console.log(ul.children.length);    // 3 (ElementNode 포함)
for(const each of ul.children){
    console.log('===' + each+'===');
} 

// firstChild, lastChild, nextSiblig, previousSibling
// : 모든 노드를 다 탐색
// firstElementChild, lastElementChild, nextElementSiblig, previousElementSibling
// : 엘리먼트 노드만 탐색
